...
public record AnchorRecipientSpec(Long anchorFriendId, Double expansionValue) implements RecipientSpec {
    @Override public RecipientType getType() { return RecipientType.ANCHOR; }
}
