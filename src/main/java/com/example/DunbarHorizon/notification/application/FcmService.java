...
public class FcmService {
    ...
    public void sendMulticastNotification(NotificationEvent event, List<com.example.DunbarHorizon.notification.domain.Notification> savedNotifications) {
    ...
    public void dispatchMulticast(MulticastMessage message, List<String> tokens,
                                  ...
                                  List<com.example.DunbarHorizon.notification.domain.Notification> savedNotifications) {
        try {
    ...
    private void updateBulkSentStatus(List<com.example.DunbarHorizon.notification.domain.Notification> notifications) {
        notifications.forEach(com.example.DunbarHorizon.notification.domain.Notification::markAsSent);
