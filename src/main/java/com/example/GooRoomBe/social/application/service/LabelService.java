...
import com.example.GooRoomBe.social.application.port.in.LabelCommandUseCase;
...
import com.example.GooRoomBe.social.domain.label.exception.LabelNotFoundException;
import com.example.GooRoomBe.social.domain.label.Label;
import com.example.GooRoomBe.social.domain.label.LabelCreator;
import com.example.GooRoomBe.social.domain.label.LabelMemberRegistry;
import com.example.GooRoomBe.social.domain.label.LabelNamePolicy;
...
import com.example.GooRoomBe.social.domain.socialUser.exception.UserReferenceNotFoundException;
...
public class LabelService implements LabelCommandUseCase, LabelQueryUseCase {
    ...
    @Override
    public List<LabelResponse> getAllLabels(Long ownerId) {
