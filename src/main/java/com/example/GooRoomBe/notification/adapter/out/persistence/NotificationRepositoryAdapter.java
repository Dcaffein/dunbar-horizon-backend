...
import com.example.GooRoomBe.notification.adapter.out.persistence.mongo.NotificationMongoRepository;
...
public class NotificationRepositoryAdapter implements NotificationRepository {
    ...
    public Slice<Notification> findAllByReceiverId(Long receiverId, Pageable pageable) {
        return notificationMongoRepository.findAllByReceiverId(receiverId, pageable);
    }
