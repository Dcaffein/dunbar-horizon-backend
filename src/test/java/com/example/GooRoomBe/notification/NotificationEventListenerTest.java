package com.example.GooRoomBe.notification;
...
import com.example.GooRoomBe.notification.application.FcmService;
import com.example.GooRoomBe.notification.application.NotificationEventListener;
...
class NotificationEventListenerTest {
    ...
    void handleNotificationRequest_BulkSaveAndSend() {
        ...
        verify(fcmService).sendMulticastNotification(eq(event), eq(capturedNotifications));
    }
}