...
import com.example.GooRoomBe.social.application.service.FriendRequesterActionService;
...
class FriendRequesterActionServiceTest {
    ...
    void createFriendRequest_Success() {
        ...
        given(friendRequestRepository.existsRequestBetween(reqId, resId)).willReturn(false);
